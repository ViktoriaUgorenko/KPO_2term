...
int main() {
    ...
    try {
        ...
        Instance test1 = Create("AAAAAAAAAAAAAAAAAAAAA", 5);
#endif
        ...
        Entry e1 = { 18, "Бабич" }, e2 = { 6, "Шинкевич" }, e3 = { 37, "Угоренко" }, e4 = { 13, "Подшиваленко" }, e5 = { 7, "Яскевич" };
        AddEntry(d1, e1);
        AddEntry(d1, e2);
        AddEntry(d1, e3);
        AddEntry(d1, e4);
        ...
        Entry s1 = { 1, "Барковский" }, s2 = { 16, "Белодед" }, s3 = { 3, "Наркевич" }, s4 = { 4, "Пустовалова" }, s5 = { 5, "Чайковский" };
        AddEntry(d2, s1);
        AddEntry(d2, s2);
        AddEntry(d2, s3);
        AddEntry(d2, s4);
